...
class AlternatifAnggotaController extends Controller
{
    /**
    ...
    {
      $new_alternatif = AlternatifAnggota::get();
      return view('pages.alternatif.anggota',['anggota' => $new_alternatif]);
    }
    ...
    public function store(Request $request)
    {
      ...
      $alternatif = AlternatifAnggota::where('kode_alternatif', $request->kode_alternatif)->first('kode_alternatif');
      if ($alternatif) {
        Alert::error('Gagal', 'Kode Alternatif Sudah Ada!');
        return response()->json('Berhasil');
      }else {
        $new_alternatif = new AlternatifAnggota;
    ...
    {
      $new_alternatif = AlternatifAnggota::find($id);
      return response()->json($new_alternatif);
    }
     ...
     */
     public function edit(Request $request)
     {
       ...
       $new_alternatif = AlternatifAnggota::find($request->id);
       $new_alternatif->kode_alternatif = $request->kode_alternatif;
       $new_alternatif->nama_alternatif = $request->nama_alternatif;
       $new_alternatif->t_alternatif = $request->t_alternatif;
       $new_alternatif->tl_alternatif = $request->tl_alternatif;
    ...
    {
      $new_alternatif = AlternatifAnggota::findOrFail($id);
