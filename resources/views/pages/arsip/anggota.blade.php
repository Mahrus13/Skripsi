  ...
  <div class="col">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="mb-0">Data Tabel Arsip Nilai Anggota Periode {{date('d M Y', strtotime($data->periode))}}</h3>
      ...
      <div class="table-responsive py-4">
        <table class="table table-striped table-bordered" id="datatable-basic{{++$number}}">
          ...
          <tbody>
            <?php $number1 = 0; ?>
            <?php
            $b= DB::table('riwayat_penilaian_anggota')
                      ->join('periode_anggota', 'periode_anggota.id', '=', 'riwayat_penilaian_anggota.periode_id')
                      ->where('riwayat_penilaian_anggota.periode_id', $data->id)
                      ->orderBy('jumlah','desc')
