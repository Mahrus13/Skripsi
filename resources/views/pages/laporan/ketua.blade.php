...
<div class="row align-items-center py-4">
  ...
  <!-- Modal Tambah-->
  <div class="modal fade" id="riwayatKetua" tabindex="-1" role="dialog" aria-labelledby="kriteriaKetuaLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="kriteriaKetuaLabel">Periode Pemilihan Ketua</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <form id="riwayatKetuaForm" enctype="multipart/form-data">
            @csrf
...
<div class="card-header">
  ...
  <div class="text-right">
    ...
    <button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#riwayatKetua">
...
$('#riwayatKetuaForm').submit(function(e) {
  e.preventDefault();
  var periode = $("input[name=periode]");
  var _token = $("input[name=_token]");

  $.ajax({
    url: "{{route('riwayatKetua.add')}}",
    type: "POST",
    data: {
      periode: periode.val(),
      _token: _token.val()
