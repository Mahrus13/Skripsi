...
<div class="row align-items-center py-4">
  <div class="col-lg-6 col-7">
    <h6 class="h2 text-white d-inline-block mb-0">Alternatif Ketua</h6>
  ...
  <div class="col-lg-6 col-5 text-right">
    ...
    <button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#alternatifKetua">
      <span class="btn-inner--icon"><i class="fas fa-plus"></i></span>
      <span class="btn-inner--text">Tambah</span>
    </button>
    @endif
    <!-- Modal Tambah-->
    <div class="modal fade" id="alternatifKetua" tabindex="-1" role="dialog" aria-labelledby="alternatifKetuaLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="alternatifKetuaLabel">Data Alternatif Ketua</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <form id="alternatifKetuaForm" enctype="multipart/form-data">
              @csrf
...
$('#alternatifKetuaForm').submit(function(e) {
  e.preventDefault();
  ...
  $.ajax({
    url: "{{route('alternatifKetua.tambah')}}",
    type: "POST",
    data: {
...
function editAlternatif(id) {
  var url = '{{route("alternatifKetua.getbyid",":id")}}'
  url = url.replace(':id', id)
  $.get(url, function(alternatifKetua) {
    $("#id").val(alternatifKetua.id);
    $("#kode_alternatif-update").val(alternatifKetua.kode_alternatif);
    $("#nama_alternatif-update").val(alternatifKetua.nama_alternatif);
    $("#t_alternatif-update").val(alternatifKetua.t_alternatif);
    $("#tl_alternatif-update").val(alternatifKetua.tl_alternatif);
    $("#alamat_alternatif-update").val(alternatifKetua.alamat_alternatif);
    $("#phone-update").val(alternatifKetua.telp_alternatif);
    $("#jk_alternatif-update").val(alternatifKetua.jk_alternatif);
    $("#pendidikan_alternatif-update").val(alternatifKetua.pendidikan_alternatif);
...
$("#alternatifEditForm").submit(function(e) {
  ...
  $.ajax({
    url: "{{route('alternatifKetua.edit')}}",
    type: 'PUT',
    data: {
      id: id,
...
function deleteAlternatif(id) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      var url = '{{route("alternatifKetua.delete",":id")}}'
      url = url.replace(':id', id)
      $.ajax({
        url: url,
        type: 'DELETE',
