...
<div class="row align-items-center py-4">
  ...
  <div class="col-lg-6 col-5 text-right">
    ...
    <button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#kriteriaKetua">
      <span class="btn-inner--icon"><i class="fas fa-plus"></i></span>
      <span class="btn-inner--text">Tambah</span>
    </button>
    @endif
    <!-- Modal Tambah-->
    <div class="modal fade" id="kriteriaKetua" tabindex="-1" role="dialog" aria-labelledby="kriteriaKetuaLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="kriteriaKetuaLabel">Data Kriteria Ketua</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <form id="kriteriaKetuaForm" enctype="multipart/form-data">
              @csrf
...
<div class="card-header">
  <h3 class="mb-0">Data Tabel Kriteria Ketua</h3>
...
$('#kriteriaKetuaForm').submit(function(e) {
  e.preventDefault();
