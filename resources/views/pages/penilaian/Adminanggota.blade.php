      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="penilaianKetuaLabel">Data Nilai Anggota</h5>
  ...
  <div class="col">
    <div class="card">
      <div class="card-header">
        ...
        @if($jumlah == 0)
        <form id="musik" action="{{route('hasilAnggota.add')}}" method="POST" enctype="multipart/form-data">
          @csrf
        ...
        @else
        <div class="text-right">
          <a href="javascript:void(0)" onclick="deleteAnggota()" class="btn btn-icon btn-outline-danger btn-sm" data-toggle="tooltip" data-original-title="Hapus">
...
function deleteAnggota() {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      var url = '{{route("penilaianAnggotaHapus.delete")}}'
      // url = url.replace(':id', id)
      $.ajax({
        url: url,
        type: 'DELETE',
